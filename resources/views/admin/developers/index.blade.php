...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    @include('crm.partials.stat-card', ['label' => 'إجمالي المطورين', 'value' => $stats['total'], 'accent' => 'theme', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />', 'href' => route('admin.developers.index') . '#page-data', 'linkLabel' => 'عرض المطورين'])
    @include('crm.partials.stat-card', ['label' => 'تعاقدات نشطة', 'value' => $stats['contracted'], 'accent' => 'green', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => route('admin.developers.index') . '#page-data', 'linkLabel' => 'عرض المطورين'])
    @include('crm.partials.stat-card', ['label' => 'بوابات مفعّلة', 'value' => $stats['portal_ready'], 'accent' => 'purple', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />', 'href' => route('admin.developers.index') . '#page-data', 'linkLabel' => 'عرض المطورين'])
    @include('crm.partials.stat-card', ['label' => 'المشاريع المرتبطة', 'value' => $stats['projects'], 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5" />', 'href' => route('admin.developers.index') . '#page-data', 'linkLabel' => 'عرض المطورين'])
</div>
