...
<a href="{{ route('marketing.plans.index') }}" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium {{ request()->routeIs('marketing.plans.*') ? 'active' : '' }}">خطة التسويق الشهرية</a>
<a href="{{ route('marketing.activities.index') }}" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium {{ request()->routeIs('marketing.activities.*') ? 'active' : '' }}">مهام الفريق</a>
