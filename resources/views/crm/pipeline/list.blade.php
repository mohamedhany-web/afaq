...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-5 mb-4">
    <form method="GET" class="flex flex-col lg:flex-row gap-3 lg:items-end">
        ...
        <div class="flex-1">
            ...
            <input type="text" name="search" value="{{ request('search') }}" placeholder="بحث سريع..."
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('crm.pipeline.index', request()->except('view')) }}" class="px-5 py-2.5 rounded-xl border-2 border-gray-200 text-gray-600 text-sm font-semibold hover:bg-gray-50">Kanban</a>
        </div>
    </form>
</div>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
    ...
    @if($deals->hasPages())
    <div class="p-4 border-t border-gray-100">{{ $deals->links() }}</div>
    @endif
</div>
@endsection
