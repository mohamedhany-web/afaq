...
<div class="bg-white rounded-2xl border border-gray-200 overflow-hidden font-tajawal">
    ...
    <div class="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        @endphp
        @if($itemHref)
        <a href="{{ $itemHref }}" class="block p-3 rounded-xl bg-gray-50 border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all group">
            ...
            <span class="inline-flex items-center gap-1 text-[10px] font-bold mt-2 opacity-70 group-hover:opacity-100" style="color:{{ $themeColor }}">عرض التفاصيل ←</span>
        </a>
        @else
