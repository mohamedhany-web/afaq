...
(function () {
    ...
    const checkUrl = <?php echo json_encode($checkUrl, 15, 512) ?>;
    const ignoreId = <?php echo json_encode($ignoreId, 15, 512) ?>;
    let timer = null;
    let lastChecked = '';
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\afaq\resources\views/crm/clients/partials/phone-duplicate-check.blade.php ENDPATH**/ ?>