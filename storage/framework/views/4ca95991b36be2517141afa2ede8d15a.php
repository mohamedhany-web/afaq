...
<?php $__env->startSection('page-title', 'إنشاء قيد محاسبي'); ?>
...
<form action="<?php echo e(route('accounting.journal-entries.store')); ?>" method="POST" id="journalEntryForm" class="font-tajawal">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="reference" value="<?php echo e(old('reference')); ?>" required
                       class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:border-transparent"
                       placeholder="JE-<?php echo e(date('Y')); ?>-001">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="flex flex-wrap gap-4 sm:gap-8">
                    <div>
                        ...
                        <span id="totalDebit" class="text-lg font-bold text-gray-900 tabular-nums">0 <?php echo e($currencySymbol); ?></span>
                    </div>
                    <div>
                        <span class="text-xs text-gray-500 block mb-0.5">إجمالي الدائن</span>
                        <span id="totalCredit" class="text-lg font-bold text-gray-900 tabular-nums">0 <?php echo e($currencySymbol); ?></span>
                    </div>
                </div>
    ...
    <div class="relative flex min-h-full items-center justify-center p-4">
        <div class="w-full max-w-lg bg-white rounded-2xl shadow-2xl border overflow-hidden max-h-[85vh] flex flex-col">
            ...
            <div class="overflow-y-auto flex-1 p-3 space-y-3" id="accountList">
                <?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $typeAccounts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="account-group" data-type="<?php echo e($type); ?>">
                    <h4 class="text-xs font-bold text-gray-500 px-2 mb-1.5"><?php echo e($typeLabels[$type] ?? $type); ?></h4>
                    ...
                    <button type="button"
                            ...
                            data-search="<?php echo e(strtolower($account->code.' '.$account->name)); ?>"
                            onclick="selectAccount(<?php echo e($account->id); ?>, <?php echo \Illuminate\Support\Js::from($account->name)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($account->code)->toHtml() ?>)">
                        <span class="text-sm font-semibold text-gray-900"><?php echo e($account->code); ?></span>
                        <span class="text-sm text-gray-600 mr-2"><?php echo e($account->name); ?></span>
                    </button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\accounting\journal-entries\create.blade.php ENDPATH**/ ?>