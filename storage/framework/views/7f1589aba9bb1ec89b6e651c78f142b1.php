...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 no-print">
    ...
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'حقوق الملكية', 'value' => $money($totalEquity), 'accent' => 'blue', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'التوازن', 'value' => $isBalanced ? 'متوازنة' : 'غير متوازنة', 'accent' => $isBalanced ? 'green' : 'red', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
