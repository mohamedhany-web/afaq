...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'مهام مكتملة', 'value' => $v('activities', 'completed'), 'accent' => 'purple', 'href' => '#report-body', 'linkLabel' => 'عرض التقرير'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'Leads جديدة', 'value' => $v('leads', 'created'), 'accent' => 'blue', 'href' => '#report-body', 'linkLabel' => 'عرض التقرير'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'مهام مجدولة', 'value' => $v('activities', 'assigned'), 'accent' => 'theme', 'href' => '#report-body', 'linkLabel' => 'عرض التقرير'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'حملات نشطة', 'value' => $v('campaigns', 'active_involved'), 'accent' => 'green', 'href' => '#report-body', 'linkLabel' => 'عرض التقرير'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
