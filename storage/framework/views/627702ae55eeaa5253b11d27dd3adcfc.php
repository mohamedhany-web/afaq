...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'التارجت الربع سنوي', 'value' => $contract->quarterly_target_deals ? $contract->quarterly_target_deals.' صفقة' : ($contract->quarterly_target_amount ? $money($contract->quarterly_target_amount) : '—'), 'accent' => 'theme', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'حالة التارجت', 'value' => $metTarget ? 'محقق' : 'غير محقق', 'accent' => $metTarget ? 'green' : 'amber', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'بداية العقد', 'value' => $contract->start_date?->format('Y/m/d'), 'accent' => 'blue', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'نهاية العقد', 'value' => $contract->end_date?->format('Y/m/d') ?? 'مفتوح', 'accent' => 'purple', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
