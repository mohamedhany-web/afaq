...
<form action="<?php echo e(route('crm.pipeline.store')); ?>" method="POST" class="w-full space-y-6">
        ...
        <div class="p-5 sm:p-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="md:col-span-2 xl:col-span-1">
                ...
                <select name="lead_source" class="<?php echo e($input); ?>">
                    <option value="">—</option>
                    <?php $__currentLoopData = \App\Models\Client::leadSourceLabels(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $txt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden w-full">
        ...
        <div class="p-5 sm:p-6 space-y-4 sm:space-y-6">
            <div>
                ...
                <input name="product_service" value="<?php echo e(old('product_service', request('product_service'))); ?>" required class="<?php echo e($input); ?>"
                       placeholder="مثال: شقة 3 غرف — الدور الخامس — برج النخيل">
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <div>
                    <label class="<?php echo e($label); ?>">القيمة المتوقعة (ج.م) *</label>
                    <input name="estimated_value" type="number" step="0.01" min="0" value="<?php echo e(old('estimated_value', request('estimated_value'))); ?>" required class="<?php echo e($input); ?>">
                </div>
                <div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden w-full">
        ...
        <div class="p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div>
                <label class="<?php echo e($label); ?>">موعد الاجتماع</label>
                <input name="viewing_date" type="date" value="<?php echo e(old('viewing_date')); ?>" class="<?php echo e($input); ?>">
            </div>
            <div class="sm:col-span-2 lg:col-span-3">
                <label class="<?php echo e($label); ?>">ملاحظات الاجتماع</label>
                <input name="viewing_notes" value="<?php echo e(old('viewing_notes')); ?>" class="<?php echo e($input); ?>" placeholder="تفاصيل موعد الاجتماع...">
            </div>
            <div class="sm:col-span-2 lg:col-span-3">
