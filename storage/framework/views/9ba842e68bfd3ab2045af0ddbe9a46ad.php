...
<div class="flex flex-wrap gap-3 mb-6 font-tajawal">
    ...
    <button onclick="openCreateAccountModal()" class="px-5 py-2.5 rounded-xl text-white text-sm font-semibold" style="background:linear-gradient(135deg,<?php echo e($themeColor); ?> 0%,<?php echo e($themeColor); ?>dd 100%);">إضافة حساب</button>
</div>
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-bold <?php echo e(($type === 'asset' || $type === 'expense') ? 'text-green-600' : 'text-blue-600'); ?>">
                                <?php echo e($money($account->balance)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\accounting\accounts.blade.php ENDPATH**/ ?>