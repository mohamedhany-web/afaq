...
<div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'نشطة', 'value' => $stats['total_active'], 'compact' => true, 'accent' => 'theme', 'href' => route('crm.tasks.index', ['status' => 'active']) . '#page-data', 'linkLabel' => 'عرض النشطة'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'اليوم', 'value' => $stats['due_today'], 'compact' => true, 'accent' => 'blue', 'href' => route('crm.tasks.index', ['due' => 'today']) . '#page-data', 'linkLabel' => 'عرض اليوم'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'متأخرة', 'value' => $stats['overdue'], 'compact' => true, 'accent' => 'red', 'href' => route('crm.tasks.index', ['due' => 'overdue']) . '#page-data', 'linkLabel' => 'عرض المتأخرة'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'حرجة', 'value' => $stats['critical'], 'compact' => true, 'accent' => 'amber', 'href' => route('crm.tasks.index', ['priority' => 'critical']) . '#page-data', 'linkLabel' => 'عرض الحرجة'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'أُنجزت هذا الأسبوع', 'value' => $stats['completed_week'], 'compact' => true, 'accent' => 'green', 'href' => route('crm.tasks.index', ['status' => 'completed']) . '#page-data', 'linkLabel' => 'عرض المنجزة'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<div class="flex flex-wrap gap-1 mb-3 font-tajawal">
    ...
    <a href="<?php echo e(route('crm.tasks.index', array_merge(request()->except('filter', 'page'), ['filter' => $key]))); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\crm\tasks\index.blade.php ENDPATH**/ ?>