...
<div class="mt-6">
    <h3 class="sidebar-section-title px-4"><?php echo e(__('operations.sidebar.operations_hub')); ?></h3>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-clients')): ?>
    <a href="<?php echo e(route('operations.clients.index', ['bucket' => 'all'])); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.clients.*') || request()->routeIs('operations.leads.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.clients.hub_title')); ?>
    ...
    <a href="<?php echo e(route('crm.clients.approvals.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('crm.clients.approvals.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.client_approvals')); ?>

    </a>
    <?php endif; ?>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-analytics', 'view-reports')): ?>
    <a href="<?php echo e(route('operations.crm.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.crm.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.crm_tracking')); ?>
    ...
    <a href="<?php echo e(route('operations.follow-ups.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.follow-ups.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.follow_ups')); ?>
    ...
    <a href="<?php echo e(route('operations.inventory.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.inventory.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.inventory')); ?>
    ...
    <a href="<?php echo e(route('operations.team.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.team.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.team_performance')); ?>

    </a>
    <?php endif; ?>
</div>
<div class="mt-6">
    <h3 class="sidebar-section-title px-4"><?php echo e(__('operations.sidebar.operations')); ?></h3>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-all-projects', 'view-own-projects')): ?>
    <a href="<?php echo e(route('crm.projects.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('crm.projects.*') ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
        <?php echo e(__('operations.sidebar.real_estate_projects')); ?>

    </a>
    <?php endif; ?>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-developers', 'manage-developers')): ?>
    <a href="<?php echo e(route('admin.developers.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('admin.developers.*') ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
        <?php echo e(__('operations.sidebar.developers')); ?>
    ...
    <a href="<?php echo e(route('operations.reports.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.reports.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.my_periodic_reports')); ?>
    ...
    <a href="<?php echo e(route('admin.system-reports.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('admin.system-reports.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.system_reports')); ?>

    </a>
    <?php endif; ?>
</div>
<div class="mt-6">
    <h3 class="sidebar-section-title px-4"><?php echo e(__('operations.sidebar.team_resources')); ?></h3>
    ...
    <a href="<?php echo e(route('operations.leaves.index', ['status' => 'pending'])); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.leaves.*') ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
        <?php echo e(__('operations.sidebar.leave_approvals')); ?>

    </a>
    <a href="<?php echo e(route('operations.exit-permits.index', ['status' => 'pending'])); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('operations.exit-permits.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.exit_permit_approvals')); ?>

    </a>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-users')): ?>
    <a href="<?php echo e(route('users.index', ['workspace' => 'operations'])); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('users.*') && request('workspace') === 'operations' ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
        <?php echo e(__('operations.sidebar.operations_users')); ?>

    </a>
    <?php endif; ?>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-attendance')): ?>
    <a href="<?php echo e(route('attendances.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('attendances.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.attendance')); ?>

    </a>
    <?php endif; ?>
    <?php echo $__env->make('layouts.partials.sidebar-leaves-link', ['label' => __('operations.sidebar.leaves')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('layouts.partials.sidebar-exit-permit-link', ['label' => __('operations.sidebar.request_exit_permit')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php if(auth()->user()?->canAccessCrm()): ?>
<div class="mt-6">
    <h3 class="sidebar-section-title px-4"><?php echo e(__('operations.sidebar.sales')); ?></h3>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'access-crm', 'view-sales')): ?>
    <a href="<?php echo e(route('crm.dashboard')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('crm.dashboard') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.sales_dashboard')); ?>
    ...
    <a href="<?php echo e(route('crm.pipeline.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('crm.pipeline.*') ? 'active' : ''); ?>">
        ...
        <?php echo e(__('operations.sidebar.sales_pipeline')); ?>
