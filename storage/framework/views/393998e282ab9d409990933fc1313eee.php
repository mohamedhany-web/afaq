...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'مرحلة الرحلة', 'value' => $stageLabels[$client->lead_stage] ?? $client->lead_stage, 'accent' => 'theme', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />', 'href' => '#client-journey', 'linkLabel' => 'عرض الرحلة'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الصفقات', 'value' => $dealsCount, 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2" />', 'href' => '#client-deals-section', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'قيمة الصفقات', 'value' => $money($dealsValue), 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />', 'href' => '#client-deals-section', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-5 space-y-3 text-sm font-tajawal">
                ...
                <div>
                    ...
                    <div class="mt-1"><?php echo $__env->make('crm.clients.partials.source-badge', ['source' => $client->lead_source], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></div>
                </div>
                <div>
                    <span class="text-xs font-bold text-gray-500">تصنيف العميل</span>
                    <p class="text-gray-900"><?php echo $__env->make('crm.clients.partials.type-badge', ['type' => $client->client_type], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></p>
                </div>
                <?php endif; ?>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-700 whitespace-pre-line"><?php echo e($client->description); ?></p>
                </div>
                <?php endif; ?>
            </div>
    ...
    <div class="xl:col-span-2">
        <?php echo $__env->make('crm.clients.partials.deals-list', [
            'client' => $client,
