...
<a href="<?php echo e(route('hr.dashboard')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('hr.dashboard') ? 'active' : ''); ?>">
...
<div class="mt-6">
    ...
    <a href="<?php echo e(route('employees.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('employees.dossier') || request()->routeIs('employees.show') ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
        ملفات الموظفين
    </a>
...
<div class="mt-6">
    ...
    <a href="<?php echo e(route('employees.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('employees.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('users.index', ['workspace' => 'hr'])); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('users.*') && request('workspace') === 'hr' ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\afaq\resources\views\layouts\partials\sidebar-hr.blade.php ENDPATH**/ ?>