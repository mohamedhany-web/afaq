...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6 w-full">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="px-5 sm:px-6 py-4 border-t border-gray-100 flex flex-col gap-2">
            <a href="<?php echo e(route('employees.dossier', array_merge(['employee' => $employee], $listQuery))); ?>"
    ...
    <div class="xl:col-span-2 space-y-6" id="employee-profile">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <div>
                    <dt class="<?php echo e($fieldLabel); ?>">دوام يومي</dt>
                    <dd class="<?php echo e($fieldValue); ?>" dir="ltr"><?php echo e($scheduleService->scheduleLabel($employee)); ?></dd>
                </div>
                <div>
                    <dt class="<?php echo e($fieldLabel); ?>">ساعات العمل</dt>
                    <dd class="<?php echo e($fieldValue); ?>"><?php echo e($scheduleService->requiredDailyHours($employee)); ?> ساعة</dd>
                </div>
                <div>
                    <dt class="<?php echo e($fieldLabel); ?>">إجازة أسبوعية</dt>
                    <dd class="<?php echo e($fieldValue); ?>"><?php echo e($scheduleService->offDaysLabel($employee)); ?></dd>
                </div>
                <div>
                    <dt class="<?php echo e($fieldLabel); ?>">سماح التأخير</dt>
                    <dd class="<?php echo e($fieldValue); ?>"><?php echo e($scheduleService->lateGraceMinutes($employee)); ?> دقيقة</dd>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div class="<?php echo e($sectionHeader); ?> flex items-center justify-between"
                ...
                <span class="text-xs font-semibold font-tajawal px-3 py-1 rounded-lg" style="background: <?php echo e($themeColor); ?>15; color: <?php echo e($themeColor); ?>;">
                    <?php echo e(number_format($salesValue ?? 0)); ?> ج.م إجمالي
                </span>
            </div>
            <div class="p-5 sm:p-6">
