                ...
                <tfoot class="bg-gray-50">
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">
                            <?php echo e($money($journalEntry->total_debit)); ?>

                        </td>
                        <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">
                            <?php echo e($money($journalEntry->total_credit)); ?>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($money($journalEntry->total_debit)); ?></div>
                </div>
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="text-sm font-medium text-gray-600 mb-2">إجمالي الدائن</div>
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($money($journalEntry->total_credit)); ?></div>
                </div>
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="flex items-center text-red-600">
                        ...
                        <span class="text-sm mr-2">(الفرق: <?php echo e($money(abs($journalEntry->balance_difference))); ?>)</span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\accounting\journal-entries\show.blade.php ENDPATH**/ ?>