...
<div class="mt-6">
    ...
    <a href="<?php echo e(route('marketing.campaigns.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.campaigns.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('marketing.plans.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.plans.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('marketing.activities.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.activities.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('marketing.leads.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.leads.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('marketing.reports.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.reports.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('marketing.analytics.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.analytics.*') ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
        تحليلات الأداء
    </a>
    <a href="<?php echo e(route('marketing.team.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.team.*') ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        فريق التسويق
    </a>
    <?php echo $__env->make('layouts.partials.sidebar-leaves-link', ['label' => 'إجازات الفريق'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<div class="mt-6">
...
<?php /**PATH C:\xampp\htdocs\afaq\resources\views\layouts\partials\sidebar-marketing-manager.blade.php ENDPATH**/ ?>