...
<div class="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الحملات', 'value' => $summary['campaigns'], 'accent' => 'purple', 'href' => route('marketing.analytics.index') . '#page-data', 'linkLabel' => 'عرض التحليلات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'Leads', 'value' => $summary['leads'], 'accent' => 'blue', 'href' => route('marketing.analytics.index') . '#page-data', 'linkLabel' => 'عرض التحليلات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'نشطة', 'value' => $summary['active'], 'accent' => 'green', 'href' => route('marketing.analytics.index') . '#page-data', 'linkLabel' => 'عرض التحليلات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الميزانية', 'value' => number_format($summary['budget']), 'accent' => 'amber', 'href' => route('marketing.analytics.index') . '#page-data', 'linkLabel' => 'عرض التحليلات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'المصروف', 'value' => number_format($summary['spent']), 'accent' => 'theme', 'href' => route('marketing.analytics.index') . '#page-data', 'linkLabel' => 'عرض التحليلات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'عملاء نشطون', 'value' => $summary['conversion_hint'], 'accent' => 'green', 'href' => route('marketing.analytics.index') . '#page-data', 'linkLabel' => 'عرض التحليلات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
