...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الفواتير', 'value' => $totalInvoices, 'accent' => 'theme', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'مدفوعة', 'value' => $paidInvoices, 'accent' => 'green', 'compact' => true, 'footer' => '<span class="text-gray-500">'.($totalInvoices > 0 ? round(($paidInvoices / $totalInvoices) * 100) : 0).'%</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'معلقة', 'value' => $pendingInvoices, 'accent' => 'amber', 'compact' => true, 'footer' => '<span class="text-amber-600">'.$money($pendingAmount).'</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الإيرادات', 'value' => $money($totalRevenue), 'accent' => 'purple', 'compact' => true, 'footer' => '<span class="text-gray-500">'.$money($monthlyRevenue).' هذا الشهر</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
