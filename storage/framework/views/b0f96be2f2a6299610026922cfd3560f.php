...
<div class="grid md:grid-cols-3 gap-4 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الرواتب', 'value' => $money($runs->sum('net_pay')), 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'العمولات', 'value' => $money($runs->sum('commission_total')), 'compact' => true, 'accent' => 'green'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'المكافآت المعتمدة', 'value' => $money($bonuses->sum('amount')), 'compact' => true, 'accent' => 'amber'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
