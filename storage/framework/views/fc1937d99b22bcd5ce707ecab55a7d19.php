...
<?php echo $__env->make('projects.partials.inventory-source-fields', compact('project', 'developers', 'themeColor', 'input', 'label', 'sectionHeader'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('projects.partials.manual-units-table', compact('project', 'themeColor', 'input'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('projects.partials.map-picker', ['project' => $project ?? null, 'themeColor' => $themeColor], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
