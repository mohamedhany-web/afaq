...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <select name="property_type" required class="<?php echo e($input); ?>">
                <?php $__currentLoopData = \App\Models\Project::PROPERTY_TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $txt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($val); ?>" <?php if(old('property_type', $project->property_type ?? 'residential') === $val): echo 'selected'; endif; ?>><?php echo e($txt); ?></option>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden w-full">
    ...
    <div class="p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div>
            ...
            <input type="number" name="price_from" min="0" step="0.01" value="<?php echo e(old('price_from', $project->price_from ?? '')); ?>" class="<?php echo e($input); ?>">
        </div>
        <div>
            <label class="<?php echo e($label); ?>">السعر إلى (ج.م)</label>
            <input type="number" name="price_to" min="0" step="0.01" value="<?php echo e(old('price_to', $project->price_to ?? '')); ?>" class="<?php echo e($input); ?>">
        </div>
    </div>
</div>
