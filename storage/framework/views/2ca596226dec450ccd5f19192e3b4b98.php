...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-5 mb-6 no-print font-tajawal">
    <form method="GET" class="flex flex-col lg:flex-row flex-wrap items-stretch lg:items-end gap-3">
        ...
        <div>
            ...
            <input type="date" name="start_date" value="<?php echo e($startDate); ?>" class="<?php echo e($inputClass); ?>" required>
        </div>
        <div>
            <label class="block text-xs font-bold text-gray-500 mb-1.5">إلى تاريخ</label>
            <input type="date" name="end_date" value="<?php echo e($endDate); ?>" class="<?php echo e($inputClass); ?>" required>
        </div>
        <?php else: ?>
        <div>
            <label class="block text-xs font-bold text-gray-500 mb-1.5">حتى تاريخ</label>
            <input type="date" name="date" value="<?php echo e($date); ?>" class="<?php echo e($inputClass); ?>" required>
        </div>
        <?php endif; ?>
        <button type="submit"
...
<?php /**PATH C:\xampp\htdocs\afaq\resources\views\accounting\partials\report-toolbar.blade.php ENDPATH**/ ?>