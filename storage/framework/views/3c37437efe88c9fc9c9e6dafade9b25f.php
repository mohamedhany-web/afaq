...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <?php echo $__env->make('partials.client-search-select', ['required' => true, 'value' => old('client_id', $ticket->client_id), 'label' => $ticket->client ? \App\Http\Controllers\ClientSearchController::formatLabel($ticket->client) : null, 'inputClass' => 'w-full px-3 py-2 border border-gray-300 rounded-lg', 'crmScope' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\tickets\edit.blade.php ENDPATH**/ ?>