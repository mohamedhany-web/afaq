...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden w-full mb-6" id="building-units-root"
     ...
     data-show-url="<?php echo e($unitShowUrl); ?>"
    ...
    <div class="px-5 sm:px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"
        ...
        <div class="flex flex-wrap gap-2">
            <?php if($canEdit && $hasUnits): ?>
            <form method="POST" action="<?php echo e($unitsRenumberRoute); ?>">
                <?php echo csrf_field(); ?>
                <button type="submit"
    ...
    <div class="p-5 sm:p-6">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4" id="unit-stats-strip">
            <?php $__currentLoopData = config('project_units.use_types'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($count > 0): ?>
                <div class="rounded-xl border border-gray-200 p-3 text-center" data-use-type="<?php echo e($key); ?>">
        ...
        <div class="flex flex-wrap gap-2 mb-4 font-tajawal">
            ...
            <button type="button" class="floor-filter px-3 py-1.5 rounded-lg text-xs font-bold border border-gray-200 bg-white text-gray-600 hover:bg-gray-50"
                    data-floor-id="<?php echo e($floor->id); ?>" title="<?php echo e(ProjectUnitNumbering::floorLabelEn($floor->level)); ?>">
                <?php echo e($floor->label); ?>

                <span class="text-gray-400 font-mono" dir="ltr">(<?php echo e(ProjectUnitNumbering::floorPrefix($floor->level)); ?>)</span>
            </button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between gap-2 mb-3">
                ...
                <span class="text-xs text-gray-400 font-tajawal" id="unit-cards-count"><?php echo e($unitsPayload->count()); ?> وحدة</span>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3" id="unit-cards-grid">
                <?php $__currentLoopData = $floors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <article class="unit-card rounded-xl border-2 border-gray-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow font-tajawal"
                             ...
                             data-use-type="<?php echo e($unit->use_type); ?>"
                             style="border-color: <?php echo e($fill); ?>33;">
                        <div class="px-3 py-2.5 flex items-center justify-between gap-2" style="background: <?php echo e($fill); ?>14;">
                            <button type="button"
                                    class="unit-code-link text-lg font-extrabold text-gray-900 hover:underline font-mono tracking-tight"
                                    dir="ltr"
                                    data-unit-id="<?php echo e($unit->id); ?>"
                                    title="عرض تفاصيل <?php echo e($unit->code); ?>">
                                <?php echo e($unit->code); ?>

                            </button>
                            <span class="text-[10px] font-bold px-2 py-0.5 rounded-full unit-card-status"
                                  style="color: <?php echo e($fill); ?>; background: <?php echo e($fill); ?>22;">
                        ...
                        <div class="px-3 py-2 space-y-1.5 text-xs text-gray-600">
                            <div class="flex justify-between gap-2">
                                ...
                                <span class="font-semibold text-gray-800"><?php echo e($floor->label); ?></span>
                            </div>
                            <div class="flex justify-between gap-2">
                                <span class="text-gray-400">الاستخدام</span>
                                <span class="font-semibold" style="color: <?php echo e($useColors[$unit->use_type] ?? '#64748b'); ?>"><?php echo e($unit->useTypeLabel()); ?></span>
                            </div>
                            <div class="flex justify-between gap-2">
                                <span class="text-gray-400">المساحة</span>
                                <span class="font-semibold text-gray-800"><?php echo e(number_format($unit->area_m2)); ?> م²</span>
                            </div>
                            <div class="flex justify-between gap-2">
                                <span class="text-gray-400">كاش</span>
                                <span class="font-bold" style="color: <?php echo e($themeColor); ?>"><?php echo e($money($unit->price_cash)); ?></span>
                            </div>
                            <?php if($unit->price_installment): ?>
                            <div class="flex justify-between gap-2">
                                <span class="text-gray-400">قسط</span>
                                <span class="font-semibold text-gray-700"><?php echo e($money($unit->price_installment)); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                        <button type="button"
                    ...
                    <div class="building-floor-row flex items-stretch gap-2 transition-opacity" data-floor-id="<?php echo e($floor->id); ?>">
                        ...
                        <div class="flex-1 flex gap-1.5 p-1.5 rounded-lg border border-slate-200 bg-white min-h-[2.5rem]">
                            ...
                            <button type="button"
                                    ...
                                    title="<?php echo e($unit->code); ?> — <?php echo e($unit->useTypeLabel()); ?> — <?php echo e($unit->statusLabel()); ?> — انقر للتفاصيل">
                                <?php echo e($unit->code); ?>
        ...
        <div id="unit-detail-modal" class="fixed inset-0 z-[60] hidden" aria-hidden="true" role="dialog" aria-labelledby="modal-unit-code">
            ...
            <div class="absolute inset-x-3 sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2 top-4 sm:top-10 bottom-4 sm:bottom-auto sm:max-h-[90vh] w-auto sm:w-full sm:max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl border border-gray-200 flex flex-col font-tajawal">
                <div class="px-5 py-4 border-b border-gray-100 flex items-start justify-between gap-3 shrink-0"
                     style="background: linear-gradient(135deg, <?php echo e($themeColor); ?>10 0%, transparent 100%);">
                    <div>
                    ...
                    <div class="rounded-xl border border-gray-200 p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                            <div>
                                ...
                                <div class="text-lg font-extrabold" id="modal-cash" style="color: <?php echo e($themeColor); ?>">—</div>
...
(function () {
    ...
    const floorLevelLabels = <?php echo json_encode(collect(config('project_units.floor_levels', []))->mapWithKeys(fn ($v, $k) => [(string) $k => $v['label'] ?? (string) $k])->all()) ?>;
...
<style>
    ...
    #building-units-root .unit-card.ring-2 { --tw-ring-color: <?php echo e($themeColor); ?>; }
</style>
<?php $__env->stopPush(); ?>
<?php endif; ?>
