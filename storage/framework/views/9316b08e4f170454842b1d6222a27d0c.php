...
<div class="w-full">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <form method="GET" action="<?php echo e(route('contracts.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <!-- Client Filter -->
            <div>
                <?php echo $__env->make('partials.client-search-select', ['required' => false, 'value' => request('client_id'), 'inputClass' => 'w-full px-3 py-2 border border-gray-300 rounded-lg', 'crmScope' => false, 'placeholder' => 'ابحث لتصفية حسب عميل...'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\contracts\index.blade.php ENDPATH**/ ?>