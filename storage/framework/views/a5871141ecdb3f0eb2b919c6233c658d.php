...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4">
    ...
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'وحدات متاحة', 'value' => number_format($stats['available_units']), 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7" />'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-5 mb-6">
    <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:items-end">
        <div class="lg:col-span-2">
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="اسم المشروع، المدينة..."
