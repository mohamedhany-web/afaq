...
<?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-marketing', 'view-dashboard')): ?>
...
<?php endif; ?>
<?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-marketing')): ?>
<div class="mt-6">
    ...
    <?php endif; ?>
    <a href="<?php echo e(route('marketing.leads.create')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('marketing.leads.create') ? 'active' : ''); ?>">إضافة Lead</a>
