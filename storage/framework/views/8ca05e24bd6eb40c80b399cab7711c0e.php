    ...
    <div class="p-5 sm:p-6 space-y-4">
        <div class="flex flex-col sm:flex-row gap-2">
            ...
            <button type="button" id="map-add-unit-pin" class="px-5 py-3 rounded-xl border-2 text-sm font-semibold font-tajawal shrink-0"
                    style="border-color: <?php echo e($themeColor); ?>40; color: <?php echo e($themeColor); ?>;">+ علامة وحدة</button>
        ...
        <input type="hidden" name="latitude" id="map_latitude" value="<?php echo e($defaultLat); ?>">
        <input type="hidden" name="longitude" id="map_longitude" value="<?php echo e($defaultLng); ?>">
        <input type="hidden" name="map_zoom" id="map_zoom" value="<?php echo e($defaultZoom); ?>">
        <input type="hidden" name="map_pins_payload" id="map_pins_payload" value="<?php echo e(json_encode($initialPins, JSON_UNESCAPED_UNICODE)); ?>">
...
<style>
    ...
    .crm-map-pin.project .crm-map-pin-body { background: <?php echo e($themeColor); ?>; }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let pins = <?php echo json_encode($initialPins, 15, 512) ?>;
    ...
    map.on('click', function (e) {
        ...
        if (projectIdx >= 0) {
            ...
            addPin(e.latlng.lat, e.latlng.lng, 'project', <?php echo json_encode(isset($project) ? $project->name : 'موقع المشروع', 15, 512) ?>);
        }
    });
...
<?php /**PATH C:\xampp\htdocs\afaq\resources\views/projects/partials/map-picker.blade.php ENDPATH**/ ?>