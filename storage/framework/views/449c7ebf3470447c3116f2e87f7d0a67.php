...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 w-full">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الوحدات', 'value' => $project->total_units ?? 0, 'accent' => 'theme', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7" />', 'href' => '#building-units-root', 'linkLabel' => 'عرض الوحدات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'متاح', 'value' => $project->available_units ?? 0, 'accent' => 'green', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4" />', 'href' => '?status=available#building-units-root', 'linkLabel' => 'عرض المتاح'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الصفقات', 'value' => $project->sales_count, 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2" />', 'href' => '#project-sales', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'قيمة الصفقات', 'value' => \App\Helpers\SettingsHelper::formatMoney($stats['sales_value']), 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2" />', 'href' => '#project-sales', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<?php echo $__env->make('projects.partials.classification-filter', compact('project', 'themeColor'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6 w-full">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="p-5 sm:p-6 space-y-4">
            ...
            <div><dt class="<?php echo e($fieldLabel); ?>">تصنيف المشروع</dt><dd class="<?php echo e($fieldValue); ?>"><?php echo e($project->property_type_name); ?></dd></div>
            ...
            <?php if($project->requiresRegisteredDeveloper()): ?>
            ...
            <div id="project-detail-price-block">
                <dt class="<?php echo e($fieldLabel); ?>">السعر حسب التصنيف</dt>
        ...
        <div class="p-5 sm:p-6">
            ...
            <a href="<?php echo e(route('crm.pipeline.show', $sale)); ?>" class="block p-4 mb-3 last:mb-0 rounded-xl border border-gray-100 hover:bg-gray-50 font-tajawal">
                ...
                <div class="text-xs text-gray-500 mt-1 flex flex-wrap items-center gap-1">
                    <?php if($sale->client): ?>
                    <a href="<?php echo e($sale->client->profileUrl()); ?>" class="hover:underline" style="color: <?php echo e($themeColor); ?>;"><?php echo e($sale->client->name); ?></a>
                    <?php endif; ?>
                    <?php if($sale->salesRep): ?>
                    <span class="text-gray-300">·</span>
                    <a href="<?php echo e(route('crm.team-members.show', $sale->salesRep)); ?>" class="hover:underline"><?php echo e($sale->salesRep->name); ?></a>
                    <?php endif; ?>
                </div>
            </a>
