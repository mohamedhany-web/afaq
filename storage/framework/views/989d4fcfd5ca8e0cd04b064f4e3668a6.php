...
<head>
    <meta charset="utf-8">
    <title>عقد وكيل عقاري مستقل — <?php echo e($contract->user?->name); ?></title>
    <style>
...
<p class="meta"><?php echo e($companyName); ?></p>

<p>إنه في يوم: <strong><?php echo e($contract->signed_at?->locale('ar')->translatedFormat('l') ?? '...............'); ?></strong> الموافق: <strong><?php echo e($contract->signed_at?->format('d / m / Y') ?? '.... / .... / ........'); ?></strong></p>
<p>تم الاتفاق بين كل من:</p>

<p><strong>الطرف الأول:</strong> شركة <strong><?php echo e($companyName); ?></strong> للاستثمار والتسويق العقاري، ويمثلها في التوقيع السيد/ <strong><?php echo e($contract->company_signatory_name ?? '.......................................'); ?></strong> بصفته <strong><?php echo e($contract->company_signatory_title ?? 'المدير التنفيذي'); ?></strong>.</p>

<p><strong>الطرف الثاني:</strong> السيد/ <strong><?php echo e($contract->user?->name); ?></strong>، الجنسية: <strong><?php echo e($contract->nationality ?? '....................'); ?></strong>، بطاقة الرقم القومي: <strong><?php echo e($contract->national_id ?? '.......................................'); ?></strong>، والمقيم في: <strong><?php echo e($contract->address ?? '.......................................................'); ?></strong>، رقم الهاتف: <strong><?php echo e($contract->phone ?? $contract->user?->phone ?? '......................................'); ?></strong>.</p>
...
<ol>
    ...
    <li>يتم الصرف خلال <?php echo e(config('freelance_agents.payout_days_min')); ?> إلى <?php echo e(config('freelance_agents.payout_days_max')); ?> يوم عمل من تحصيل العمولة.</li>
    <?php if($contract->quarterly_target_deals || $contract->quarterly_target_amount): ?>
    <li>التارجت الربع سنوي المتفق عليه: <?php if($contract->quarterly_target_deals): ?><strong><?php echo e($contract->quarterly_target_deals); ?> صفقة</strong><?php endif; ?> <?php if($contract->quarterly_target_amount): ?><strong><?php echo e(number_format($contract->quarterly_target_amount)); ?> جنيه</strong><?php endif; ?> — عند تحقيقه تُطبّق نسبة 50% لمبيعات المطورين (Primary).</li>
    <?php endif; ?>
</ol>
...
<p>مدة العقد سنة واحدة من <strong><?php echo e($contract->start_date->format('Y/m/d')); ?></strong><?php if($contract->end_date): ?> إلى <strong><?php echo e($contract->end_date->format('Y/m/d')); ?></strong><?php endif; ?> وتتجدد تلقائيًا ما لم يُخطر أحد الطرفين قبل شهر. يحق الإنهاء بإخطار كتابي قبل 15 يومًا مع صرف عمولات العمليات المغلقة قبل الإنهاء.</p>
...
<div class="signatures">
    <div>
        ...
        <div class="sig-box">الاسم: <?php echo e($contract->company_signatory_name ?? '.......................'); ?><br>الصفة: <?php echo e($contract->company_signatory_title ?? '.......................'); ?></div>
    </div>
    <div>
        <p><strong>توقيع الطرف الثاني (الوكيل)</strong></p>
        <div class="sig-box">الاسم: <?php echo e($contract->user?->name); ?><br>التوقيع: .......................</div>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\afaq\resources\views\crm\freelance-agents\contract-print.blade.php ENDPATH**/ ?>