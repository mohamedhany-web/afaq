...
<div class="grid grid-cols-2 gap-3 sm:gap-4 mb-6 max-w-lg">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'قوالب المندوبين', 'value' => $repTemplates->count(), 'compact' => true, 'accent' => 'blue'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'قوالب المديرين', 'value' => $mgrTemplates->count(), 'compact' => true, 'accent' => 'purple'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
