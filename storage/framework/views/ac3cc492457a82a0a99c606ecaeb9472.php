...
<div class="w-full max-w-full">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="<?php echo e(route('client-accounts.update', $clientAccount)); ?>" class="space-y-6">
            ...
            <div>
                <?php echo $__env->make('partials.client-search-select', ['required' => true, 'value' => old('client_id', $clientAccount->client_id), 'label' => $clientAccount->client ? \App\Http\Controllers\ClientSearchController::formatLabel($clientAccount->client) : null, 'inputClass' => 'w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500', 'crmScope' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\client-accounts\edit.blade.php ENDPATH**/ ?>