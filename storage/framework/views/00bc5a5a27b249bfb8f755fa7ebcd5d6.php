...
?>
<span class="inline-flex items-center gap-1 text-xs font-tajawal <?php echo e($class ?? 'text-gray-500'); ?>">
    ...
    <span>أضافه: <strong class="font-semibold <?php echo e($isAdmin ? 'text-amber-700' : 'text-gray-700'); ?>"><?php echo e($creatorName); ?></strong></span>
    <?php if($isAdmin): ?>
    <span class="px-1.5 py-px rounded text-[10px] font-bold bg-amber-100 text-amber-800">إدارة</span>
    <?php endif; ?>
</span>
<?php /**PATH C:\xampp\htdocs\afaq\resources\views/crm/clients/partials/created-by.blade.php ENDPATH**/ ?>