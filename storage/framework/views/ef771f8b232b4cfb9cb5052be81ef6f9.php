    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden flex flex-col">
        <div class="px-4 py-3 border-b border-gray-100 flex items-start gap-3"
            ...
            <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-xs font-bold text-white font-tajawal"
                  style="background: <?php echo e($themeColor); ?>;"><?php echo e($section['num']); ?></span>
            <div class="min-w-0">
                <h3 class="font-bold text-gray-900 text-sm font-tajawal leading-tight"><?php echo e($section['title']); ?></h3>
                <p class="text-xs text-gray-500 font-tajawal"><?php echo e($section['subtitle']); ?></p>
            </div>
        </div>
        <dl class="p-4 space-y-2 flex-1">
            ...
            ?>
            <div class="flex items-center justify-between gap-3 rounded-xl px-3 py-2.5 <?php echo e($bg); ?>">
                <dt class="text-xs font-semibold text-gray-600 font-tajawal"><?php echo e($item['label']); ?></dt>
                <dd class="text-lg font-bold <?php echo e($valColor); ?> font-tajawal tabular-nums shrink-0"><?php echo e($item['value']); ?></dd>
            </div>
...
<?php /**PATH C:\xampp\htdocs\afaq\resources\views\crm\daily-reports\partials\metrics-grid.blade.php ENDPATH**/ ?>