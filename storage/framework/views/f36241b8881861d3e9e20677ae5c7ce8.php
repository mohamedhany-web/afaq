...
<button type="button"
        ...
        aria-pressed="false"
        data-label-on="<?php echo e($labelOn ?? 'عرض مبسّط'); ?>"
        data-label-off="<?php echo e($labelOff ?? 'عرض التفاصيل'); ?>">
    <span class="ui-compact-icon-on hidden">
        <svg class="w-5 h-5" style="color:<?php echo e($themeColor); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <span class="ui-compact-label"><?php echo e($labelOff ?? 'عرض التفاصيل'); ?></span>
</button>
<?php /**PATH C:\xampp\htdocs\afaq\resources\views\partials\ui-compact-toggle.blade.php ENDPATH**/ ?>