...
<div class="flex flex-wrap items-center gap-2 mb-4">
    ...
    <a href="<?php echo e(route('crm.pipeline.index', $query)); ?>"
       class="px-3 py-1.5 rounded-lg text-xs font-semibold font-tajawal <?php echo e(($current ?? 'clients') === 'clients' ? 'text-white' : 'border border-gray-200 text-gray-700 hover:bg-gray-50'); ?>"
       <?php if(($current ?? 'clients') === 'clients'): ?> style="background: <?php echo e($themeColor); ?>;" <?php endif; ?>>عملاء + صفقات</a>
    ...
    <a href="<?php echo e(route('crm.pipeline.index', array_merge($query, ['view' => 'list']))); ?>"
       ...
       <?php if(($current ?? '') === 'list'): ?> style="background: <?php echo e($themeColor); ?>;" <?php endif; ?>>جدول</a>
