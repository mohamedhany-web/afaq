...
<div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 mb-3 items-stretch">
    ...
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إيرادات الشهر', 'value' => $money($k['monthly_revenue']), 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />', 'href' => route('crm.pipeline.index', ['view' => 'deals', 'stage' => 'closed_won']), 'linkLabel' => 'عرض الإيرادات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'عملاء نشطون', 'value' => number_format($k['total_leads']), 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />', 'href' => auth()->user()->clientsHubUrl(['status' => 'active']), 'linkLabel' => 'عرض العملاء'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'عملاء مؤهلون', 'value' => number_format($k['qualified_leads']), 'accent' => 'purple', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => auth()->user()->clientsHubUrl(['status' => 'active']), 'linkLabel' => 'عرض المؤهّلين'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-4">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'غير مُعيَّنين', 'value' => $leadDistribution['unassigned_count'], 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />', 'href' => '#lead-distribution', 'linkLabel' => 'عرض التوزيع'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'نسبة التعيين', 'value' => $leadDistribution['assigned_pct'] . '%', 'accent' => 'green', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => '#lead-distribution', 'linkLabel' => 'عرض التوزيع'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'متوسط الاستجابة', 'value' => $leadDistribution['response_hours'] . ' س', 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => '#lead-distribution', 'linkLabel' => 'عرض التوزيع'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'متابعات متأخرة', 'value' => $leadDistribution['overdue_count'], 'accent' => 'purple', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => route('crm.follow-ups.index', ['filter' => 'overdue']), 'linkLabel' => 'عرض المتابعات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<div id="lead-distribution" class="grid grid-cols-1 xl:grid-cols-12 gap-4 sm:gap-6 mb-6">
    <div class="xl:col-span-5 bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="px-5 py-3 border-b border-gray-200 flex justify-between" style="<?php echo e($headerStyle); ?>">
            ...
            <a href="<?php echo e(route('crm.leads.distribution')); ?>" class="text-xs font-semibold" style="color:<?php echo e($themeColor); ?>">عرض الكل</a>
        </div>
        <ul class="divide-y divide-gray-100 p-2">
            ...
            <li class="px-3 py-2.5 flex justify-between items-center text-sm font-tajawal hover:bg-gray-50 rounded-lg">
                <div>
                    <a href="<?php echo e($client->profileUrl()); ?>" class="font-semibold text-gray-900 hover:underline"><?php echo e($client->name); ?></a>
