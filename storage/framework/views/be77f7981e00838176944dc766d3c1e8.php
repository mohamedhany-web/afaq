...
<div class="grid grid-cols-1 xl:grid-cols-12 gap-4 sm:gap-6">
    <div class="xl:col-span-8 space-y-4">
        ...
        <div class="bg-white rounded-2xl border overflow-hidden">
            ...
            <ul class="divide-y font-tajawal text-sm">
                ...
                <li class="px-5 py-3">
                    <span class="font-semibold"><?php echo e($log->action === 'transferred' ? 'تحويل' : $log->action); ?></span>
                    <?php if($log->notes): ?><span class="text-gray-700"> — <?php echo e($log->notes); ?></span><?php endif; ?>
                    <?php if($log->old_status && $log->new_status && $log->action !== 'transferred'): ?><span class="text-gray-500"> <?php echo e($log->old_status); ?> → <?php echo e($log->new_status); ?></span><?php endif; ?>
    ...
    <div class="xl:col-span-4 space-y-4">
        <div class="bg-white rounded-2xl border p-5 font-tajawal space-y-3">
            ...
            <?php endif; ?>
            <?php if($canTransfer && ($assignableUsers ?? collect())->isNotEmpty() && !in_array($task->status, ['completed','verified','archived','cancelled'])): ?>
            <form method="POST" action="<?php echo e(route('crm.tasks.transfer', $task)); ?>" class="space-y-2 pt-2 border-t border-gray-100"
                ...
                <select name="assigned_to" required class="w-full border-2 border-gray-200 rounded-xl px-3 py-2 text-sm">
                    ...
                    <?php if((int) $user->id !== (int) $task->assigned_to): ?>
                    <option value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?></option>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <button type="submit" class="w-full py-2.5 rounded-xl text-white text-sm font-bold" style="background:<?php echo e($themeColor); ?>">تحويل المهمة</button>
            </form>
            <?php endif; ?>
        ...
        <div class="bg-white rounded-2xl border p-4 text-sm font-tajawal">
            ...
            <a href="<?php echo e($task->client->profileUrl()); ?>" class="font-bold" style="color:<?php echo e($themeColor); ?>"><?php echo e($task->client->name); ?></a>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\crm\tasks\show.blade.php ENDPATH**/ ?>