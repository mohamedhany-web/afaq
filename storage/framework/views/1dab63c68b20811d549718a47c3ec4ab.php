...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 no-print">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الإيرادات', 'value' => $money($totalRevenue), 'accent' => 'green', 'compact' => true, 'href' => route('accounting.reports.income-statement') . '#page-data', 'linkLabel' => 'عرض التقرير'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي المصروفات', 'value' => $money($totalExpenses), 'accent' => 'red', 'compact' => true, 'href' => route('accounting.reports.income-statement') . '#page-data', 'linkLabel' => 'عرض التقرير'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الفترة', 'value' => $reportStartDate->format('Y/m/d') . ' — ' . $reportEndDate->format('Y/m/d'), 'accent' => 'theme', 'compact' => true, 'href' => route('accounting.reports.income-statement') . '#page-data', 'linkLabel' => 'عرض التقرير'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
