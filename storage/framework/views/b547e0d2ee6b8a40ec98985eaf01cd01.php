...
<div class="grid grid-cols-3 gap-3 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الفريق', 'value' => $stats['total'], 'accent' => 'purple'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'مديرون', 'value' => $stats['managers'], 'accent' => 'theme'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'موظفون', 'value' => $stats['reps'], 'accent' => 'blue'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
    ...
    <div class="bg-white rounded-2xl shadow-lg border p-5 font-tajawal">
        ...
        <p class="text-xs mt-2">
            ...
            <span class="px-2 py-0.5 rounded bg-purple-50 text-purple-700"><?php echo e(\App\Helpers\RoleHelper::getRoleName($role->name)); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views/marketing/team/index.blade.php ENDPATH**/ ?>