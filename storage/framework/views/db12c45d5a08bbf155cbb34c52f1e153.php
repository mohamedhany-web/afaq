...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 font-tajawal">
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 space-y-4">
        ...
        <div class="border-t pt-4 space-y-2 text-sm">
            ...
            <p><span class="text-gray-500">نوع العقار:</span> <?php echo e(\App\Models\Project::PROPERTY_TYPES[$projectData['property_type'] ?? ''] ?? '—'); ?></p>
        ...
        <p class="text-sm text-red-700 bg-red-50 border border-red-200 rounded-xl p-4">طلب حذف المشروع: <strong><?php echo e($payload['project_name'] ?? $request->project?->name); ?></strong></p>
        <?php endif; ?>
