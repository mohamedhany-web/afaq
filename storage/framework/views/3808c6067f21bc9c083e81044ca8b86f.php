...
<div class="grid grid-cols-3 gap-3 mb-4">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الإجمالي', 'value' => $stats['total'], 'accent' => 'purple', 'href' => route('marketing.leads.index') . '#page-data', 'linkLabel' => 'عرض القائمة'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'اليوم', 'value' => $stats['today'], 'accent' => 'blue', 'href' => route('marketing.leads.index', ['period' => 'today']) . '#page-data', 'linkLabel' => 'عرض اليوم'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الشهر', 'value' => $stats['month'], 'accent' => 'green', 'href' => route('marketing.leads.index', ['period' => 'month']) . '#page-data', 'linkLabel' => 'عرض الشهر'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
    ...
    <table class="w-full text-sm font-tajawal">
        ...
        <tbody class="divide-y">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3" dir="ltr"><?php echo e($lead->phone); ?></td>
