...
<div class="mb-6 flex flex-wrap items-center justify-between gap-4 font-tajawal">
    <div>
        ...
        <?php elseif($todayAttendance->current_status === 'checkout_pending'): ?>
...
<?php if($todayAttendance && $todayAttendance->check_in && !$todayAttendance->check_out && $todayAttendance->current_status !== 'checkout_pending'): ?>
...
<div class="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-3 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الموظفين', 'value' => $stats['total_employees'], 'accent' => 'theme', 'compact' => true, 'href' => route('attendances.index') . '#page-data', 'linkLabel' => 'عرض السجل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'حاضرون / سجّلوا', 'value' => $stats['present_today'], 'accent' => 'green', 'compact' => true, 'href' => route('attendances.index', ['status' => 'present']) . '#page-data', 'linkLabel' => 'عرض الحاضرين'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'غائبون', 'value' => $stats['absent_today'], 'accent' => 'red', 'compact' => true, 'href' => route('attendances.index', ['status' => 'absent']) . '#page-data', 'linkLabel' => 'عرض الغائبين'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'متأخرون', 'value' => $stats['late_today'], 'accent' => 'amber', 'compact' => true, 'href' => route('attendances.index', ['status' => 'late']) . '#page-data', 'linkLabel' => 'عرض المتأخرين'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php if($isToday): ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'يعملون الآن', 'value' => $stats['working_now'], 'accent' => 'blue', 'compact' => true, 'href' => route('attendances.index', ['status' => 'working']) . '#page-data', 'linkLabel' => 'عرض النشطين'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'معدل الحضور', 'value' => $stats['attendance_rate'] . '%', 'accent' => 'purple', 'compact' => true, 'href' => route('attendances.index') . '#page-data', 'linkLabel' => 'عرض السجل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
    ...
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        ...
        <div class="w-full sm:w-40">
            ...
            <select name="status" class="w-full border-2 border-gray-200 rounded-xl px-4 py-2.5 text-sm">
                ...
                <option value="checkout_pending" <?php if(request('status') === 'checkout_pending'): echo 'selected'; endif; ?>>انصراف بانتظار العمليات</option>
        ...
        <table class="w-full text-sm min-w-[1000px]">
            ...
            <tr class="hover:bg-gray-50/80">
                ...
                <td class="p-3">
                    ...
                    <?php endif; ?>
                    <?php elseif($att?->current_status === 'checkout_pending'): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function cancelCheckout() {
        ...
        fetch('<?php echo e(route("attendances.cancel-checkout")); ?>', {
            method: 'POST',
            headers: csrfHeaders(),
