...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي المدفوعات', 'value' => $totalPayments, 'accent' => 'theme', 'compact' => true, 'footer' => '<span class="text-gray-500">'.$monthlyPayments.' هذا الشهر</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'واردة', 'value' => $incomingPayments, 'accent' => 'green', 'compact' => true, 'footer' => '<span class="text-green-600">'.$money($totalIncoming).'</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'صادرة', 'value' => $outgoingPayments, 'accent' => 'red', 'compact' => true, 'footer' => '<span class="text-red-600">'.$money($totalOutgoing).'</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'معلقة', 'value' => $pendingPayments, 'accent' => 'amber', 'compact' => true, 'footer' => '<span class="text-amber-600">'.$money($pendingAmount).'</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
