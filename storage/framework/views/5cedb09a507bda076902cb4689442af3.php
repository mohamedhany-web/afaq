...
<div class="w-full font-tajawal">
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1"><?php echo e($start_date); ?> — <?php echo e($end_date); ?></p>
                </div>
            </div>
            <a href="<?php echo e(route('reports.sales.print', request()->query())); ?>" target="_blank" class="inline-flex items-center justify-center px-5 py-2.5 rounded-xl text-white text-sm font-semibold shadow-sm" style="background: <?php echo e($themeColor); ?>">
                طباعة التقرير
            </a>
        </div>
        ...
        <form method="GET" class="flex flex-wrap gap-3 items-end bg-white rounded-xl border border-gray-200 p-4">
            <div>
                ...
                <input type="date" name="start_date" value="<?php echo e($start_date); ?>" class="border-2 border-gray-200 rounded-xl px-3 py-2 text-sm">
            </div>
            <div>
                <label class="block text-xs font-bold text-gray-500 mb-1">إلى</label>
                <input type="date" name="end_date" value="<?php echo e($end_date); ?>" class="border-2 border-gray-200 rounded-xl px-3 py-2 text-sm">
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            ...
            <p class="text-2xl font-bold text-green-600"><?php echo e($money($summary['total_amount'])); ?></p>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            <p class="text-sm font-medium text-gray-600 mb-1">متوسط الصفقة</p>
            <p class="text-2xl font-bold text-gray-900"><?php echo e($money($summary['average_sale'] ?? 0)); ?></p>
        </div>
    </div>
            ...
            <table class="w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 text-gray-900"><?php echo e($sale->expected_close_date?->format('Y-m-d') ?? '—'); ?></td>
                        <td class="px-4 py-3">
                            <?php echo $__env->make('crm.partials.entity-link', ['type' => 'client', 'entity' => $sale->client], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3">
                            <a href="<?php echo e(route('crm.pipeline.show', $sale)); ?>" class="hover:underline" style="color: <?php echo e($themeColor); ?>"><?php echo e($sale->product_service); ?></a>
                        </td>
                        <td class="px-4 py-3 font-bold text-green-600"><?php echo e($money($sale->amount)); ?></td>
                        <td class="px-4 py-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\reports\sales.blade.php ENDPATH**/ ?>