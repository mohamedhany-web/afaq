    ...
    <div class="p-2 border-b border-gray-50">
        <div class="flex items-start gap-1">
            ...
            <div class="flex-1 min-w-0">
                <a href="<?php echo e(route('crm.clients.show', $client)); ?>" class="font-bold text-[12px] text-gray-900 hover:underline block truncate" draggable="false"><?php echo e($client->name); ?></a>
    ...
    <details class="client-deals-panel border-b border-gray-50" open>
        ...
        <div class="px-2 pb-2 space-y-1 max-h-36 overflow-y-auto" onclick="event.stopPropagation()">
            ...
            <div class="rounded-md border border-gray-100 bg-gray-50/80 p-1.5 text-[10px]">
                ...
                <p class="text-[9px] text-amber-700 mt-0.5">معاينة: <?php echo e(\Carbon\Carbon::parse($sale->viewing_date)->format('Y/m/d')); ?></p>
                <?php endif; ?>
            </div>
