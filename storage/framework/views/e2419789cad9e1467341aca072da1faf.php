...
<div class="grid grid-cols-3 gap-3 sm:gap-4 mb-6">
    ...
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'معتمدة الشهر', 'value' => $stats['approved'], 'accent' => 'green', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'مرفوضة الشهر', 'value' => $stats['rejected'], 'accent' => 'red', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
