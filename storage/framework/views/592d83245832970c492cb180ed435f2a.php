...
<div class="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الصفقات', 'value' => $stats['total_deals'], 'accent' => 'theme', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7" />', 'href' => '#member-deals', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'صفقات نشطة', 'value' => $stats['active_deals'], 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />', 'href' => '#member-deals', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'تم البيع', 'value' => $stats['won_deals'], 'accent' => 'green', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => '#member-deals', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'قيمة المسار', 'value' => $money($stats['pipeline_value']), 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />', 'href' => '#member-deals', 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'تحديثات اليوم', 'value' => $stats['today_updates'], 'accent' => 'purple', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => '#member-deals', 'linkLabel' => 'عرض النشاط'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
        ...
        <div class="p-5 space-y-3 max-h-[400px] overflow-y-auto">
            <?php $__empty_1 = true; $__currentLoopData = $todayDeals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-3 rounded-xl border border-gray-100 hover:bg-gray-50">
                    <?php if($deal->client): ?>
                    <a href="<?php echo e($deal->client->profileUrl()); ?>" class="font-semibold text-sm font-tajawal hover:underline block" style="color:<?php echo e($themeColor); ?>"><?php echo e($deal->client->name); ?></a>
                    <?php else: ?>
                    <p class="font-semibold text-sm font-tajawal">—</p>
                    <?php endif; ?>
                    <a href="<?php echo e(route('crm.pipeline.show', $deal)); ?>" class="text-xs text-gray-500 mt-1 font-tajawal block hover:underline">
                        <?php echo e($deal->product_service); ?> · <?php echo e($stageLabels[$deal->stage] ?? $deal->stage); ?> · <?php echo e($money($deal->estimated_value)); ?> · <?php echo e($deal->updated_at->format('H:i')); ?>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="p-5 space-y-3 max-h-[400px] overflow-y-auto">
            <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e($client->profileUrl()); ?>" class="block p-3 rounded-xl border border-gray-100 hover:bg-gray-50">
        ...
        <table class="w-full text-sm">
            ...
            <?php $__currentLoopData = $deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="border-t border-gray-100 hover:bg-gray-50">
                    <td class="p-4"><a href="<?php echo e($deal->client?->profileUrl()); ?>" class="font-medium font-tajawal" style="color: <?php echo e($themeColor); ?>;"><?php echo e($deal->client?->name); ?></a></td>
