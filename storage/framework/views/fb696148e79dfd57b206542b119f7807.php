...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    ...
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'نوع الدفعة', 'value' => $typeName, 'accent' => $isIncoming ? 'green' : 'red', 'compact' => true, 'href' => '#payment-details', 'linkLabel' => 'عرض التفاصيل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الحالة', 'value' => $statusName, 'accent' => $statusAccent, 'compact' => true, 'href' => '#payment-details', 'linkLabel' => 'عرض التفاصيل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'تاريخ الدفعة', 'value' => $payment->payment_date->format('Y/m/d'), 'accent' => 'theme', 'compact' => true, 'href' => '#payment-details', 'linkLabel' => 'عرض التفاصيل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>

<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6" id="payment-details">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="<?php echo e($sectionHeader); ?>" style="<?php echo e($headerStyle); ?>">تفاصيل الدفعة</div>
        <div class="p-5 sm:p-6">
            <dl class="space-y-3 text-sm font-tajawal">
                <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                    ...
                    <dd class="font-bold text-gray-900 tabular-nums"><?php echo e($payment->payment_number); ?></dd>
                </div>
                <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                    <dt class="text-gray-500 shrink-0">الاتجاه</dt>
                    <dd>
                        <span class="text-xs font-bold px-2 py-1 rounded-lg <?php echo e($isIncoming ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                            <?php echo e($isIncoming ? 'واردة' : 'صادرة'); ?>
                ...
                <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                    ...
                    <dd class="font-semibold text-gray-900 tabular-nums"><?php echo e($payment->reference_number); ?></dd>
                </div>
                <?php endif; ?>
                <?php if($payment->bankAccount): ?>
                <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                    <dt class="text-gray-500 shrink-0">حساب البنك</dt>
                    <dd class="font-semibold text-gray-900 text-left"><?php echo e($payment->bankAccount->code); ?> — <?php echo e($payment->bankAccount->name); ?></dd>
                </div>
                <?php endif; ?>
                <?php if($payment->creator): ?>
                <div class="flex justify-between gap-4 py-2">
                    <dt class="text-gray-500 shrink-0">سجّلها</dt>
                    <dd class="font-semibold text-gray-900"><?php echo e($payment->creator->name); ?></dd>
                </div>
                <?php endif; ?>
            </dl>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="<?php echo e($sectionHeader); ?>" style="<?php echo e($headerStyle); ?>">معلومات الربط</div>
        <div class="p-5 sm:p-6">
            <dl class="space-y-3 text-sm font-tajawal">
                ...
                <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                    ...
                    <dd class="font-semibold text-gray-900"><?php echo e($payment->employee->first_name); ?> <?php echo e($payment->employee->last_name); ?></dd>
                </div>
                <?php endif; ?>
                ...
                <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                    ...
                    <dd>
                        <a href="<?php echo e(route('financial-invoices.show', $payment->invoice)); ?>"
                           class="font-semibold hover:underline" style="color: <?php echo e($themeColor); ?>;">
                ...
                <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                    ...
                    <dd class="font-semibold text-gray-900 tabular-nums"><?php echo e($money($payment->invoice->total_amount)); ?></dd>
                </div>
                <div class="flex justify-between gap-4 py-2">
                    <dt class="text-gray-500 shrink-0">متبقي الفاتورة</dt>
                    <dd class="font-semibold text-gray-900 tabular-nums"><?php echo e($money($payment->invoice->balance_due ?? 0)); ?></dd>
                </div>
                <?php elseif(!$payment->client && !$payment->employee): ?>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="<?php echo e($sectionHeader); ?>" style="<?php echo e($headerStyle); ?>">الوصف</div>
        <div class="p-5 sm:p-6">
            <p class="text-sm text-gray-700 font-tajawal leading-relaxed whitespace-pre-wrap"><?php echo e($payment->description ?: '—'); ?></p>
        </div>
    </div>

    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="<?php echo e($sectionHeader); ?>" style="<?php echo e($headerStyle); ?>">ملاحظات</div>
        <div class="p-5 sm:p-6">
            <?php if($payment->notes): ?>
            <p class="text-sm text-gray-700 font-tajawal leading-relaxed whitespace-pre-wrap"><?php echo e($payment->notes); ?></p>
            <?php else: ?>
...
<script>
const markCompletedUrl = <?php echo json_encode(route('payments.mark-as-completed', $payment), 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\payments\show.blade.php ENDPATH**/ ?>