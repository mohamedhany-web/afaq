        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td class="py-2.5 px-4 text-gray-700 font-tajawal truncate max-w-[12rem]"><?php echo e($deal->project?->name ?? '—'); ?></td>
                    <td class="py-2.5 px-4 text-gray-600 font-tajawal"><?php echo e($deal->salesRep?->name ?? '—'); ?></td>
