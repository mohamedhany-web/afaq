...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'أدوار نشطة', 'value' => $stats['total_roles'], 'accent' => 'theme'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'صلاحيات CRM', 'value' => $stats['total_permissions'], 'accent' => 'purple'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'المستخدمون', 'value' => $stats['total_users'], 'accent' => 'blue'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'فريق المبيعات', 'value' => $stats['crm_users'], 'accent' => 'amber'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 mb-6 overflow-hidden">
    ...
    <div class="p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="rounded-xl border border-gray-200 p-5 hover:shadow-md transition" style="background: linear-gradient(135deg, <?php echo e($color); ?>08, <?php echo e($color); ?>03);">
                ...
                <p class="text-xs text-gray-500 mt-1 font-tajawal"><?php echo e($role->name); ?></p>
                <p class="text-sm text-gray-600 mt-2 font-tajawal"><?php echo e($meta['description']); ?></p>
                <?php if(!empty($meta['workspace'])): ?>
                    <span class="inline-block mt-3 text-[10px] px-2 py-1 rounded-full bg-gray-100 text-gray-600 font-tajawal">
                        <?php echo e(match($meta['workspace']) {
                            'admin' => 'لوحة الإدارة',
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
    <div class="px-5 sm:px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        ...
        <a href="<?php echo e(route('users.index')); ?>" class="text-xs font-semibold font-tajawal px-3 py-2 rounded-lg" style="background: <?php echo e($themeColor); ?>15; color: <?php echo e($themeColor); ?>;">إدارة المستخدمين</a>
    </div>
