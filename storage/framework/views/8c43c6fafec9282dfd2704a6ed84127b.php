...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'Leads', 'value' => $campaign->leads_count, 'accent' => 'blue', 'href' => '#campaign-details', 'linkLabel' => 'عرض التفاصيل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'المهام', 'value' => $campaign->activities_count, 'accent' => 'purple', 'href' => '#campaign-details', 'linkLabel' => 'عرض التفاصيل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الميزانية', 'value' => number_format($campaign->budget ?? 0), 'accent' => 'amber', 'href' => '#campaign-details', 'linkLabel' => 'عرض التفاصيل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'المصروف', 'value' => number_format($campaign->spent_amount ?? 0), 'accent' => 'theme', 'href' => '#campaign-details', 'linkLabel' => 'عرض التفاصيل'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
