...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الأصول', 'value' => $money($totalAssets), 'accent' => 'green', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي الخصوم', 'value' => $money($totalLiabilities), 'accent' => 'amber', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'صافي الدخل', 'value' => $money(abs($netIncome)), 'accent' => $netIncome >= 0 ? 'green' : 'red', 'compact' => true, 'footer' => $netIncome >= 0 ? '<span class="text-green-600">ربح</span>' : '<span class="text-red-600">خسارة</span>'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الرصيد المتاح', 'value' => $money($totalAssets - $totalLiabilities), 'accent' => 'blue', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<div class="w-full">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 mb-8 font-tajawal">
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الأصول', 'value' => $money($totalAssets), 'accent' => 'green', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الخصوم', 'value' => $money($totalLiabilities), 'accent' => 'amber', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'حقوق الملكية', 'value' => $money($totalEquity ?? 0), 'accent' => 'blue', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'الإيرادات', 'value' => $money($totalRevenue ?? 0), 'accent' => 'purple', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'المصروفات', 'value' => $money($totalExpenses ?? 0), 'accent' => 'red', 'compact' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
