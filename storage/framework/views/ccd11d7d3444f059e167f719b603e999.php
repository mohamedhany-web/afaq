...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 space-y-4 text-sm">
        ...
        <p><span class="text-gray-500">العميل:</span> <a href="<?php echo e($sale->client?->profileUrl()); ?>" class="font-semibold" style="color: <?php echo e($themeColor); ?>;"><?php echo e($sale->client?->name); ?></a></p>
        <p><span class="text-gray-500">المشروع:</span>
            <?php echo $__env->make('crm.partials.entity-link', ['type' => 'project', 'entity' => $sale->project], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </p>
        ...
        <p><span class="text-gray-500">اجتماع:</span> <?php echo e($sale->viewing_date?->format('Y-m-d') ?? '—'); ?></p>
        <p><span class="text-gray-500">مندوب المبيعات:</span>
            <?php echo $__env->make('crm.partials.entity-link', ['type' => 'rep', 'entity' => $sale->salesRep], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </p>
    </div>
