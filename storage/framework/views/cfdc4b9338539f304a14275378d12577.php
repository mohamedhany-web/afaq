<?php $lostReasons = $lostReasons ?? config('crm_intelligence.lost_reasons'); ?>
        ...
        <div class="p-5 space-y-4">
            <div>
                ...
                <select id="lost-reason-select" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm">
                    ...
                    <?php $__currentLoopData = $lostReasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\afaq\resources\views/crm/partials/lost-reason-modal.blade.php ENDPATH**/ ?>