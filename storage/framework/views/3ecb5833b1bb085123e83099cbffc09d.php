...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="<?php echo e($label); ?>">ساعات العمل *</label>
                <input type="number" name="daily_hours" value="<?php echo e(old('daily_hours', $employee->daily_hours ?? 8)); ?>" required min="1" max="12" class="<?php echo e($input); ?>">
