...
<div class="flex flex-wrap items-center gap-3 mb-6 font-tajawal">
    <?php echo $__env->make('partials.ui-compact-toggle', ['themeColor' => $themeColor], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>

<?php if(!empty($portalPulse)): ?>
<div class="mb-6 font-tajawal">
    <h2 class="text-sm font-bold text-gray-800 mb-2">بوابة العملاء — متابعة الإدارة</h2>
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'عملاء لديهم بوابة', 'value' => $portalPulse['clients_with_portal'], 'accent' => 'theme', 'href' => route('client-accounts.index'), 'linkLabel' => 'الحسابات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'اجتماعات معلّقة', 'value' => $portalPulse['pending_meetings'], 'accent' => 'purple', 'href' => route('client-meeting-requests.index'), 'linkLabel' => 'عرض'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'بلاغات مفتوحة', 'value' => $portalPulse['open_issues'], 'accent' => 'amber', 'href' => route('client-website-issues.index'), 'linkLabel' => 'عرض'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('crm.partials.stat-card', ['label' => 'تذاكر مفتوحة', 'value' => $portalPulse['open_tickets'], 'accent' => 'blue', 'href' => route('tickets.index'), 'linkLabel' => 'عرض'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</div>
<?php endif; ?>
...
<div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 mb-6 items-stretch">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إجمالي العملاء', 'value' => number_format($k['total_leads']), 'accent' => 'theme', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />', 'href' => auth()->user()->clientsHubUrl(), 'linkLabel' => 'عرض العملاء'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'جدد اليوم', 'value' => $k['new_leads_today'], 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />', 'href' => auth()->user()->clientsHubUrl(), 'linkLabel' => 'عرض العملاء'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'فرص نشطة', 'value' => $k['active_opportunities'], 'accent' => 'blue', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7" />', 'href' => route('crm.pipeline.index', ['view' => 'deals']), 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'صفقات الشهر', 'value' => $k['closed_deals_month'], 'accent' => 'green', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => route('crm.pipeline.index', ['view' => 'deals', 'stage' => 'closed_won']), 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'إيرادات الشهر', 'value' => $money($k['total_revenue']), 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />', 'href' => route('crm.pipeline.index', ['view' => 'deals', 'stage' => 'closed_won']), 'linkLabel' => 'عرض الإيرادات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>

<?php if(!$isRepOnly): ?>
<div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 mb-6 items-stretch ui-compact-hidden">
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'عملاء مؤهلون', 'value' => $k['qualified_leads'], 'accent' => 'purple', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />', 'href' => auth()->user()->clientsHubUrl(['status' => 'active']), 'linkLabel' => 'عرض العملاء'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'قيمة المسار', 'value' => $money($k['pipeline_value']), 'accent' => 'theme', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />', 'href' => route('crm.pipeline.index', ['view' => 'deals']), 'linkLabel' => 'عرض المسار'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'معدل التحويل', 'value' => $k['conversion_rate'] . '%', 'accent' => 'green', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />', 'href' => route('crm.intelligence.index'), 'linkLabel' => 'عرض التحليلات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'متوسط الصفقة', 'value' => $money($k['avg_deal_value']), 'accent' => 'amber', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2" />', 'href' => route('crm.pipeline.index', ['view' => 'deals']), 'linkLabel' => 'عرض الصفقات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('crm.partials.stat-card', ['label' => 'تحقيق الهدف', 'value' => $k['target_achievement'] . '%', 'accent' => 'theme', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />', 'href' => route('crm.compensation.dashboard'), 'linkLabel' => 'عرض التعويضات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php endif; ?>

<?php if(!empty($crmPulse)): ?>
<?php echo $__env->make('operations.partials.crm-pulse', ['crmPulse' => $crmPulse], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>

<?php echo $__env->make('crm.partials.reports-hub', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden flex flex-col h-full">
        <div class="px-4 sm:px-5 py-3 border-b border-gray-200 flex justify-between items-center" style="<?php echo e($headerStyle); ?>">
            ...
            <a href="<?php echo e(auth()->user()->clientsHubUrl()); ?>" class="text-[10px] font-semibold" style="color: <?php echo e($themeColor); ?>;">الكل</a>
        </div>
        <ul class="p-3 sm:p-4 space-y-2 flex-1">
            ...
            <li>
                <a href="<?php echo e($client->profileUrl()); ?>" class="block p-2.5 rounded-lg bg-gray-50 hover:bg-gray-100 transition text-sm font-tajawal">
        ...
        <div class="overflow-x-auto p-4 sm:p-6">
            <table class="w-full text-sm">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-b border-gray-100 hover:bg-gray-50 cursor-pointer" onclick="window.location='<?php echo e(route('crm.pipeline.show', $sale)); ?>'">
                        <td class="py-2.5"><a href="<?php echo e($sale->client?->profileUrl()); ?>" class="font-medium font-tajawal" style="color: <?php echo e($themeColor); ?>;" onclick="event.stopPropagation()"><?php echo e($sale->client?->name); ?></a></td>
                        <td class="text-gray-700 font-tajawal" onclick="event.stopPropagation()">
                            <?php echo $__env->make('crm.partials.entity-link', ['type' => 'project', 'entity' => $sale->project, 'linkClass' => 'hover:underline'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </td>
                        <td class="text-gray-600 font-tajawal" onclick="event.stopPropagation()">
                            <?php echo $__env->make('crm.partials.entity-link', ['type' => 'rep', 'entity' => $sale->salesRep, 'linkClass' => 'hover:underline'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </td>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-4 sm:p-5 space-y-2 max-h-64 overflow-y-auto">
                ...
                <div class="p-2.5 rounded-lg bg-gray-50 border border-gray-100 text-xs font-tajawal">
                    <?php if($sale->client): ?>
                    <a href="<?php echo e($sale->client->profileUrl()); ?>" class="font-semibold text-gray-900 hover:underline block"><?php echo e($sale->client->name); ?></a>
                    <?php else: ?>
                    <p class="font-semibold text-gray-900"><?php echo e($sale->product_service); ?></p>
                    <?php endif; ?>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-6">
    ...
    <div class="p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 grid grid-cols-2 sm:grid-cols-5 gap-2">
            <?php $__currentLoopData = ['calls' => 'مكالمات', 'meetings' => 'اجتماعات', 'tours' => 'اجتماعات عقارية', 'follow_ups' => 'متابعات', 'negotiations' => 'تفاوض']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="p-4 sm:p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <div class="space-y-2">
                    <?php $__empty_1 = true; $__currentLoopData = $portfolio['recent_by_ownership']['developer'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
