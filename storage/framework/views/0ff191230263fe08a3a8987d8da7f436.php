...
<form action="<?php echo e(route('crm.clients.update', $client)); ?>" method="POST" class="w-full space-y-6">
    ...
    <?php echo $__env->make('crm.clients.partials.form', ['client' => $client], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 w-full">
        <a href="<?php echo e(route('crm.clients.show', $client)); ?>" class="inline-flex items-center justify-center px-6 py-3 rounded-xl border-2 border-gray-200 text-gray-600 font-semibold text-sm hover:bg-gray-50 font-tajawal">
