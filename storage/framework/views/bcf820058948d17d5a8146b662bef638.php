...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Client -->
                <div>
                    <?php echo $__env->make('partials.client-search-select', ['required' => true, 'value' => old('client_id', $contract->client_id), 'label' => $contract->client ? \App\Http\Controllers\ClientSearchController::formatLabel($contract->client) : null, 'inputClass' => 'w-full px-4 py-3 border border-gray-300 rounded-xl', 'crmScope' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\afaq\resources\views\contracts\edit.blade.php ENDPATH**/ ?>