...
<?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-dashboard', 'access-crm')): ?>
...
<div class="mt-6">
    ...
    <a href="<?php echo e(route('crm.clients.index')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('crm.clients.index') || request()->routeIs('crm.clients.show') || request()->routeIs('crm.clients.edit') ? 'active' : ''); ?>">
    ...
    <?php endif; ?>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'view-team-sales', 'manage-sales-teams')): ?>
    <a href="<?php echo e(route('crm.leads.distribution')); ?>" class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('crm.leads.*') ? 'active' : ''); ?>">
    ...
    <?php endif; ?>
    <?php if(app(\App\Services\ClientApprovalService::class)->requiresMutationApproval(auth()->user())): ?>
    <?php if (\Illuminate\Support\Facades\Blade::check('canNav', 'edit-clients', 'delete-clients')): ?>
    ...
    <?php $managerTeam = auth()->user()->managedSalesTeams()->orderByDesc('id')->first(); ?>
    <a href="<?php echo e($managerTeam ? route('crm.teams.show', $managerTeam) : route('crm.teams.create')); ?>"
       class="sidebar-link flex items-center px-4 py-3 text-sm font-medium <?php echo e(request()->routeIs('crm.teams.*') ? 'active' : ''); ?>">
        <svg class="ml-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        <?php echo e($managerTeam ? 'فريقي' : 'إنشاء فريقي'); ?>
    ...
    <?php echo $__env->make('layouts.partials.sidebar-exit-permit-link', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<div class="mt-6">
...
<?php /**PATH C:\xampp\htdocs\afaq\resources\views\layouts\partials\sidebar-crm-manager.blade.php ENDPATH**/ ?>